...
import { EventListener, IEvent, IEventBus } from '../interface/eventBus.interface';
...
export class RabbitMQ implements IEventBus {
  ...
  async subscribe(exchange: string, routingKey: string, listener: EventListener): Promise<void> {
